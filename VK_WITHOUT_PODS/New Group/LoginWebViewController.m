...
- (void)VKwebView {
    ...
    UIBarButtonItem* item = [[UIBarButtonItem alloc]
                             initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(hideLoginView:)];
        ...
        for (NSString* pair in pairs) {
            ...
            if ([values count] == 2) {
                ...
                if ([key isEqualToString:@"access_token"]) {
                    ...
                    [[NSUserDefaults standardUserDefaults] setValue:token.userID forKey:@"myID"];
                }
            }
